            ...
            t.fn.iqDropdown = function(e) {
                return this.each(function() {
                    ...
                    u = {
                        ...
                        textPluralConjugation: r.data("text-plural-conj")
                    },
                    c = t.extend(!0, {}, n, u, e),
                    a = {},
                    l = 0;
                    ...
                    i.each(function() {
                        ...
                        function(n, e) {
                            ...
                            r.click(function(t) {
                                ...
                                r = c.beforeDecrement,
                                i = c.onChange;
                                r(n, a) && l > o && a[n] > e[n].minCount && (a[n] -= 1,
                                l -= 1,
                                u.html(a[n]),
                                s(),
                                i(n, a[n], l)),
                            ...
                            i.click(function(t) {
                                ...
                                r = c.beforeIncrement,
                                i = c.onChange;
                                r(n, a) && l < o && a[n] < e[n].maxCount && (a[n] += 1,
                                l += 1,
                                u.html(a[n]),
                                s(),
                                i(n, a[n], l)),
...
//     document.getElementsByClassName('button-decrement').style.borderColor = "red";
// }
// function myClickFunction() {
//     alert('clicked me? cool bro');
// }
// document.getElementById("onclick").addEventListener("click", myClickFunction, false);
